...
// Before & After questions - 100 days of surprising historical juxtapositions
const beforeAfterQuestions = [
  { dayNumber: 1, factA: "The Great Pyramid of Giza was built", yearA: -2560, factB: "The last woolly mammoth died", yearB: -1650, explanation: "Woolly mammoths still roamed Wrangel Island when the pyramids were already ancient monuments. The isolation of the island population allowed them to survive thousands of years after mainland extinction.", source: "Nature Journal, Egyptian Archaeological Records", category: "Ancient History" },
  { dayNumber: 2, factA: "Oxford University was founded", yearA: 1096, factB: "The Aztec Empire was established", yearB: 1428, explanation: "Oxford was educating scholars for over 300 years before the Aztecs founded their capital Tenochtitlan. European medieval institutions predate many civilizations we think of as 'ancient'.", source: "Oxford University Archives, Aztec Historical Records", category: "Education" },
  { dayNumber: 3, factA: "The fax machine was invented", yearA: 1843, factB: "The first wagon trains traveled the Oregon Trail", yearB: 1843, explanation: "Alexander Bain patented the first fax machine the same year pioneers were traveling by covered wagon to Oregon. Victorian technology was more advanced than we often realize.", source: "US Patent Office, Oregon Historical Society", category: "Technology" },
  { dayNumber: 4, factA: "Harvard University was founded", yearA: 1636, factB: "Isaac Newton developed calculus", yearB: 1665, explanation: "Students graduated from Harvard before calculus even existed. The university is older than many mathematical concepts we now consider fundamental.", source: "Harvard Archives, Royal Society Records", category: "Education" },
  { dayNumber: 5, factA: "Nintendo was founded", yearA: 1889, factB: "Jack the Ripper terrorized London", yearB: 1888, explanation: "Nintendo was founded as a playing card company just one year after the Jack the Ripper murders. The gaming giant has Victorian origins.", source: "Nintendo Corporate History, Metropolitan Police Archives", category: "Pop Culture" },
  { dayNumber: 6, factA: "The Ottoman Empire fell", yearA: 1922, factB: "Sliced bread was invented", yearB: 1928, explanation: "The Ottoman Empire, which lasted over 600 years, ended just 6 years before sliced bread was sold. 'The greatest thing since sliced bread' wasn't possible when the Ottomans ruled.", source: "Turkish Historical Society, Chillicothe Baking Company", category: "Technology" },
  { dayNumber: 7, factA: "Cleopatra lived", yearA: -30, factB: "The Great Pyramid was built", yearB: -2560, explanation: "Cleopatra lived closer in time to the Moon landing than to the construction of the Great Pyramid. The pyramids were as ancient to her as she is to us.", source: "Egyptian Archaeological Records, NASA", category: "Ancient History" },
  { dayNumber: 8, factA: "Trees first appeared on Earth", yearA: -350000000, factB: "Sharks first appeared on Earth", yearB: -450000000, explanation: "Sharks are older than trees by about 100 million years. They survived multiple mass extinctions that wiped out the dinosaurs and countless other species.", source: "Paleontological Research, Marine Biology Institute", category: "Nature" },
  { dayNumber: 9, factA: "Stegosaurus went extinct", yearA: -150000000, factB: "Tyrannosaurus Rex first appeared", yearB: -68000000, explanation: "The time between Stegosaurus and T-Rex is greater than the time between T-Rex and humans. These iconic dinosaurs never coexisted.", source: "American Museum of Natural History", category: "Dinosaurs" },
  { dayNumber: 10, factA: "Tiffany & Co. was founded", yearA: 1837, factB: "Italy became a unified country", yearB: 1861, explanation: "The iconic American jewelry company is older than the nation of Italy. Tiffany's was selling luxury goods when Italy was still a collection of separate states.", source: "Tiffany & Co. Archives, Italian Government Records", category: "Business" },
  { dayNumber: 11, factA: "Anne Frank was born", yearA: 1929, factB: "Martin Luther King Jr. was born", yearB: 1929, explanation: "These two iconic figures from different historical contexts were born the same year. Both became symbols of resistance against oppression in vastly different ways.", source: "Anne Frank House, MLK Memorial", category: "History" },
  { dayNumber: 12, factA: "The Eiffel Tower was completed", yearA: 1889, factB: "Van Gogh painted Starry Night", yearB: 1889, explanation: "The Eiffel Tower and Starry Night were created the same year. Van Gogh painted his masterpiece while the controversial iron tower was brand new.", source: "Tour Eiffel Archives, Van Gogh Museum", category: "Art" },
  { dayNumber: 13, factA: "Switzerland adopted women's suffrage nationally", yearA: 1971, factB: "The first email was sent", yearB: 1971, explanation: "Swiss women gained the right to vote the same year email was invented. Some modern technologies are older than universal suffrage in developed nations.", source: "Swiss Federal Government, ARPANET Records", category: "Society" },
  { dayNumber: 14, factA: "The London Underground opened", yearA: 1863, factB: "The American Civil War ended", yearB: 1865, explanation: "Londoners were riding the subway while Americans were still fighting the Civil War. The Underground opened two years before the war ended.", source: "Transport for London, US National Archives", category: "Transportation" },
  { dayNumber: 15, factA: "The first Star Wars movie was released", yearA: 1977, factB: "France last used the guillotine", yearB: 1977, explanation: "The last execution by guillotine in France happened the same year Star Wars premiered. Medieval punishment methods persisted into the space age.", source: "French Ministry of Justice, Lucasfilm", category: "Pop Culture" },
  { dayNumber: 16, factA: "Coca-Cola was invented", yearA: 1886, factB: "The last samurai warriors served", yearB: 1876, explanation: "The samurai class was abolished just 10 years before Coca-Cola was invented. Japanese feudal warriors overlapped with the dawn of American consumer culture.", source: "Coca-Cola Archives, Japanese Historical Society", category: "Culture" },
  { dayNumber: 17, factA: "The Brooklyn Bridge opened", yearA: 1883, factB: "The first skyscraper was built", yearB: 1885, explanation: "The Brooklyn Bridge is older than skyscrapers. The engineering marvel was completed before Chicago built the first steel-frame high-rise.", source: "NYC DOT, Chicago Architecture Foundation", category: "Architecture" },
  { dayNumber: 18, factA: "Charlie Chaplin died", yearA: 1977, factB: "Apple Computer was founded", yearB: 1976, explanation: "The silent film legend lived to see the founding of Apple Computer. Chaplin's life spanned from Victorian-era entertainment to the personal computer age.", source: "Chaplin Archives, Apple Inc.", category: "Entertainment" },
  { dayNumber: 19, factA: "The first photograph was taken", yearA: 1826, factB: "Beethoven died", yearB: 1827, explanation: "Photography existed during Beethoven's lifetime. The great composer died just one year after the first permanent photograph was created.", source: "Photography History Museum, Beethoven Archives", category: "Art" },
  { dayNumber: 20, factA: "Ecstasy (MDMA) was first synthesized", yearA: 1912, factB: "The Titanic sank", yearB: 1912, explanation: "MDMA was first created the same year the Titanic sank. The party drug has Edwardian origins.", source: "Merck Pharmaceutical Records, Maritime Archives", category: "Science" },
  { dayNumber: 21, factA: "The first computer programmer lived", yearA: 1815, factB: "The mechanical computer was invented", yearB: 1822, explanation: "Ada Lovelace, the first computer programmer, was born before the computer she would program. She wrote algorithms for Babbage's Analytical Engine.", source: "British Science Museum, Computing History", category: "Technology" },
  { dayNumber: 22, factA: "The first McDonald's opened", yearA: 1940, factB: "World War II ended", yearB: 1945, explanation: "McDonald's started during World War II. The brothers opened their first restaurant while the war was still raging.", source: "McDonald's Corporation, WWII Archives", category: "Business" },
  { dayNumber: 23, factA: "Buffalo Bill's Wild West Show toured", yearA: 1883, factB: "The first car was invented", yearB: 1886, explanation: "Buffalo Bill was performing his Wild West show about cowboys and Native Americans before cars existed. The Old West and the automobile age overlapped.", source: "Buffalo Bill Center, Mercedes-Benz Archives", category: "Entertainment" },
  { dayNumber: 24, factA: "The last Civil War widow died", yearA: 2020, factB: "The first iPhone was released", yearB: 2007, explanation: "A woman who married a Civil War veteran in 1936 lived to see smartphones. Helen Viola Jackson outlived the iPhone's creation by 13 years.", source: "US Department of Veterans Affairs, Apple Inc.", category: "History" },
  { dayNumber: 25, factA: "Alaska was purchased from Russia", yearA: 1867, factB: "The typewriter was invented", yearB: 1868, explanation: "The US bought Alaska before the typewriter existed. Seward's Folly predates this fundamental office technology.", source: "US State Department, Remington Arms Company", category: "Technology" },
  { dayNumber: 26, factA: "The first plastic was invented", yearA: 1907, factB: "The first powered flight occurred", yearB: 1903, explanation: "Humans flew before plastic was invented. Bakelite, the first synthetic plastic, came after the Wright Brothers took to the sky.", source: "Bakelite Corporation, Smithsonian Air and Space", category: "Science" },
  { dayNumber: 27, factA: "Stonehenge was completed", yearA: -2500, factB: "The last woolly rhinoceros died", yearB: -8000, explanation: "Woolly rhinos were extinct 5,500 years before Stonehenge was completed. The monument is more recent than we often imagine.", source: "English Heritage, Ice Age Research", category: "Ancient History" },
  { dayNumber: 28, factA: "Harvard University was founded", yearA: 1636, factB: "Galileo was put under house arrest", yearB: 1633, explanation: "Harvard was founded three years after Galileo was condemned. American higher education began during the age of scientific persecution.", source: "Harvard Archives, Vatican Archives", category: "Education" },
  { dayNumber: 29, factA: "The Great Fire of London occurred", yearA: 1666, factB: "The first newspaper was published", yearB: 1605, explanation: "Newspapers existed before the Great Fire of London. People could read about events in print for over 60 years before the famous fire.", source: "London Fire Brigade, British Library", category: "Media" },
  { dayNumber: 30, factA: "Oreo cookies were introduced", yearA: 1912, factB: "The first crossword puzzle appeared", yearB: 1913, explanation: "Oreos are older than crossword puzzles. America's favorite cookie predates this popular word game by a year.", source: "Nabisco, New York World", category: "Pop Culture" },
  { dayNumber: 31, factA: "Pablo Picasso died", yearA: 1973, factB: "Pink Floyd released Dark Side of the Moon", yearB: 1973, explanation: "Picasso died the same year Pink Floyd released their iconic album. The Cubist master lived into the progressive rock era.", source: "Picasso Foundation, EMI Records", category: "Art" },
  { dayNumber: 32, factA: "The first antibiotic was discovered", yearA: 1928, factB: "Sliced bread was invented", yearB: 1928, explanation: "Penicillin and sliced bread were both invented in 1928. One saves lives, one makes sandwiches easier - both changed the world.", source: "Nobel Prize Archives, Chillicothe Baking Company", category: "Science" },
  { dayNumber: 33, factA: "The University of Bologna was founded", yearA: 1088, factB: "The First Crusade began", yearB: 1096, explanation: "The world's oldest university was founded before the First Crusade. Higher education predates this pivotal religious conflict.", source: "University of Bologna, Vatican Archives", category: "Education" },
  { dayNumber: 34, factA: "The last known thylacine (Tasmanian tiger) died", yearA: 1936, factB: "The first Volkswagen Beetle was produced", yearB: 1938, explanation: "The Tasmanian tiger went extinct before the VW Beetle was created. A unique species disappeared as mass car production began.", source: "Hobart Zoo, Volkswagen Archives", category: "Nature" },
  { dayNumber: 35, factA: "The can opener was invented", yearA: 1858, factB: "The tin can was invented", yearB: 1810, explanation: "The tin can was invented 48 years before the can opener. Early users had to use hammers and chisels to open cans.", source: "Science Museum London, Patent Office", category: "Technology" },
  { dayNumber: 36, factA: "The Treaty of Versailles was signed", yearA: 1919, factB: "The first commercial radio broadcast occurred", yearB: 1920, explanation: "World War I officially ended before commercial radio existed. People learned about the war's end through newspapers, not radio.", source: "Paris Peace Conference, KDKA Pittsburgh", category: "History" },
  { dayNumber: 37, factA: "The Colosseum was completed", yearA: 80, factB: "Paper was invented in China", yearB: 105, explanation: "The Roman Colosseum is older than paper. Romans built their greatest amphitheater before the invention that would transform human communication.", source: "Roman Archaeological Society, Chinese Historical Records", category: "Ancient History" },
  { dayNumber: 38, factA: "LEGO was founded", yearA: 1932, factB: "The Empire State Building was completed", yearB: 1931, explanation: "The Empire State Building is older than LEGO. The iconic skyscraper was completed a year before the toy company started.", source: "LEGO Group, Empire State Building Archives", category: "Pop Culture" },
  { dayNumber: 39, factA: "The first color photograph was taken", yearA: 1861, factB: "The American Civil War began", yearB: 1861, explanation: "Color photography was demonstrated the same year the Civil War started. While most Civil War photos are black and white, color technology existed.", source: "Royal Institution, US National Archives", category: "Technology" },
  { dayNumber: 40, factA: "Kellogg's Corn Flakes were invented", yearA: 1894, factB: "The first modern Olympics were held", yearB: 1896, explanation: "Corn Flakes are older than the modern Olympics. Americans were eating the cereal two years before Athens hosted the first games.", source: "Kellogg Company, International Olympic Committee", category: "Pop Culture" },
  { dayNumber: 41, factA: "Machu Picchu was abandoned", yearA: 1572, factB: "Shakespeare wrote Hamlet", yearB: 1600, explanation: "Machu Picchu was abandoned about 28 years before Hamlet was written. The Incan city fell silent as Elizabethan drama flourished.", source: "Peruvian Archaeology, Shakespeare Studies", category: "History" },
  { dayNumber: 42, factA: "The zipper was invented", yearA: 1893, factB: "The first powered flight occurred", yearB: 1903, explanation: "The zipper predates airplanes by 10 years. This everyday fastener is older than human flight.", source: "US Patent Office, Smithsonian", category: "Technology" },
  { dayNumber: 43, factA: "Heroin was first synthesized", yearA: 1874, factB: "Aspirin was first synthesized", yearB: 1897, explanation: "Heroin was created 23 years before aspirin. The dangerous drug predates the common painkiller we consider harmless.", source: "Bayer Pharmaceutical Records", category: "Medicine" },
  { dayNumber: 44, factA: "Warner Bros. studio was founded", yearA: 1923, factB: "The first sound movie was released", yearB: 1927, explanation: "Warner Bros. existed for 4 years before their breakthrough sound film 'The Jazz Singer' changed cinema forever.", source: "Warner Bros. Archives, Film History Museum", category: "Entertainment" },
  { dayNumber: 45, factA: "Mexico outlawed slavery", yearA: 1829, factB: "The United States outlawed slavery", yearB: 1865, explanation: "Mexico abolished slavery 36 years before the United States. The abolition disparity drove conflicts including the Texas Revolution.", source: "Mexican Historical Archives, 13th Amendment", category: "History" },
  { dayNumber: 46, factA: "The first escalator was installed", yearA: 1892, factB: "The first elevator with automatic doors was installed", yearB: 1950, explanation: "Escalators are nearly 60 years older than automatic elevator doors. Moving stairs preceded the convenience of hands-free elevator entry.", source: "Otis Elevator Company, Patent Records", category: "Technology" },
  { dayNumber: 47, factA: "Mount Everest was first climbed", yearA: 1953, factB: "The Mariana Trench was first explored", yearB: 1960, explanation: "Humans reached the highest point on Earth 7 years before reaching the deepest. We conquered the peak before the abyss.", source: "Royal Geographical Society, US Navy", category: "Exploration" },
  { dayNumber: 48, factA: "The ballpoint pen was invented", yearA: 1938, factB: "World War II ended", yearB: 1945, explanation: "The ballpoint pen was invented during WWII. Soldiers in the war wrote with a technology that would only become widespread after the conflict.", source: "Bíró Patent, WWII Archives", category: "Technology" },
  { dayNumber: 49, factA: "Fingerprinting was first used for identification", yearA: 1892, factB: "DNA fingerprinting was discovered", yearB: 1984, explanation: "Traditional fingerprinting predates DNA identification by 92 years. Criminal investigation methods evolved dramatically over a century.", source: "Argentina Police Archives, Alec Jeffreys Research", category: "Science" },
  { dayNumber: 50, factA: "The Rosetta Stone was discovered", yearA: 1799, factB: "Egyptian hieroglyphics were deciphered", yearB: 1822, explanation: "The Rosetta Stone sat undeciphered for 23 years. Champollion finally cracked the code, unlocking ancient Egyptian history.", source: "British Museum, French Academy of Sciences", category: "Archaeology" },
  { dayNumber: 51, factA: "Blue jeans were invented", yearA: 1873, factB: "The telephone was invented", yearB: 1876, explanation: "Blue jeans are older than the telephone. Levi Strauss patented riveted denim pants three years before Alexander Graham Bell's invention.", source: "Levi Strauss & Co., US Patent Office", category: "Fashion" },
  { dayNumber: 52, factA: "The first Super Bowl was played", yearA: 1967, factB: "The first ATM was installed", yearB: 1967, explanation: "The Super Bowl and ATMs debuted the same year. American football's biggest game and cash machine convenience both arrived in 1967.", source: "NFL Archives, Barclays Bank", category: "Pop Culture" },
  { dayNumber: 53, factA: "Einstein published the theory of relativity", yearA: 1905, factB: "Picasso painted Les Demoiselles d'Avignon", yearB: 1907, explanation: "Relativity predates Cubism by two years. Physics and art were both being revolutionized in the same decade.", source: "Annalen der Physik, MoMA", category: "Science" },
  { dayNumber: 54, factA: "The Leaning Tower of Pisa began leaning", yearA: 1178, factB: "Genghis Khan united the Mongol tribes", yearB: 1206, explanation: "The Tower of Pisa started leaning before Genghis Khan rose to power. The architectural flaw predates the Mongol Empire.", source: "Pisa Historical Society, Mongolian Historical Records", category: "Architecture" },
  { dayNumber: 55, factA: "The saxophone was invented", yearA: 1846, factB: "The first jazz music was played", yearB: 1895, explanation: "The saxophone existed for 49 years before jazz. The instrument waited half a century to find its signature genre.", source: "Adolphe Sax Patent, Jazz Archives", category: "Music" },
  { dayNumber: 56, factA: "The Great Wall of China was begun", yearA: -700, factB: "Rome was founded", yearB: -753, explanation: "Rome was founded slightly before the Great Wall construction began. Both ancient marvels have similar origins in antiquity.", source: "Chinese Historical Records, Roman Archives", category: "Ancient History" },
  { dayNumber: 57, factA: "The first Harry Potter book was published", yearA: 1997, factB: "Dolly the sheep was cloned", yearB: 1996, explanation: "Cloning happened before Harry Potter. Real-world genetic magic preceded the fictional wizardry by a year.", source: "Bloomsbury Publishing, Roslin Institute", category: "Pop Culture" },
  { dayNumber: 58, factA: "The Great Chicago Fire occurred", yearA: 1871, factB: "The Great Peshtigo Fire occurred", yearB: 1871, explanation: "The deadliest fire in American history happened the same night as the Chicago Fire, but is largely forgotten. Peshtigo killed 1,500-2,500 people.", source: "Wisconsin Historical Society, Chicago Historical Society", category: "History" },
  { dayNumber: 59, factA: "Aspirin was trademarked", yearA: 1899, factB: "The first Nobel Prizes were awarded", yearB: 1901, explanation: "Aspirin predates the Nobel Prize by two years. This common medicine was already helping people when the prestigious awards began.", source: "Bayer Corporation, Nobel Foundation", category: "Medicine" },
  { dayNumber: 60, factA: "The Empire State Building was built", yearA: 1931, factB: "The Golden Gate Bridge was built", yearB: 1937, explanation: "New York's iconic skyscraper predates San Francisco's famous bridge by 6 years. Both Depression-era projects symbolize American ambition.", source: "Empire State Realty Trust, Golden Gate Bridge District", category: "Architecture" },
  { dayNumber: 61, factA: "Queen Victoria began her reign", yearA: 1837, factB: "The first photograph of a person was taken", yearB: 1838, explanation: "Queen Victoria became queen before any human was photographed. The Victorian era began before we could capture people on film.", source: "Royal Archives, Photography History Museum", category: "History" },
  { dayNumber: 62, factA: "The stethoscope was invented", yearA: 1816, factB: "The first dinosaur fossil was scientifically described", yearB: 1824, explanation: "Doctors had stethoscopes before scientists knew dinosaurs existed. Medical technology preceded paleontological discovery.", source: "Medical History Museum, Geological Society of London", category: "Science" },
  { dayNumber: 63, factA: "The toothbrush was mass-produced", yearA: 1780, factB: "The American Revolution ended", yearB: 1783, explanation: "Mass-produced toothbrushes appeared before the Revolutionary War ended. Dental hygiene was being commercialized during the fight for independence.", source: "William Addis Company, US National Archives", category: "Health" },
  { dayNumber: 64, factA: "The bikini was invented", yearA: 1946, factB: "The first atomic bomb was tested", yearB: 1945, explanation: "The bikini was named after Bikini Atoll, where the US tested nuclear weapons. The swimsuit debuted a year after the first test.", source: "Fashion History, US Department of Energy", category: "Fashion" },
  { dayNumber: 65, factA: "The Slinky was invented", yearA: 1943, factB: "D-Day occurred", yearB: 1944, explanation: "The Slinky was invented during WWII, a year before D-Day. This playful toy emerged from the same era as the war's turning point.", source: "James Industries, WWII Archives", category: "Pop Culture" },
  { dayNumber: 66, factA: "The wheel was invented", yearA: -3500, factB: "Writing was invented", yearB: -3400, explanation: "The wheel is older than writing by about 100 years. Humans were rolling before they were writing.", source: "Mesopotamian Archaeological Studies", category: "Technology" },
  { dayNumber: 67, factA: "The Statue of Liberty was dedicated", yearA: 1886, factB: "Ellis Island opened", yearB: 1892, explanation: "Lady Liberty welcomed immigrants for 6 years before Ellis Island opened. The symbol of freedom preceded the gateway.", source: "NPS, Ellis Island Foundation", category: "History" },
  { dayNumber: 68, factA: "The Periodic Table was created", yearA: 1869, factB: "The lightbulb was invented", yearB: 1879, explanation: "Chemistry was organized before we had practical electric light. Mendeleev mapped the elements a decade before Edison lit our homes.", source: "Russian Academy of Sciences, Edison Papers", category: "Science" },
  { dayNumber: 69, factA: "The first color TV broadcast occurred", yearA: 1951, factB: "The Korean War ended", yearB: 1953, explanation: "Color TV existed during the Korean War, though few saw it. The technology was demonstrated while soldiers were still fighting.", source: "CBS Broadcasting, Korean War Veterans Association", category: "Technology" },
  { dayNumber: 70, factA: "Moby Dick was published", yearA: 1851, factB: "Uncle Tom's Cabin was published", yearB: 1852, explanation: "Melville's whale tale predates Stowe's slavery narrative by one year. Two American classics emerged back-to-back.", source: "Harper & Brothers, National Era", category: "Literature" },
  { dayNumber: 71, factA: "The teddy bear was invented", yearA: 1902, factB: "The first powered flight occurred", yearB: 1903, explanation: "Teddy bears are older than airplanes by a year. The beloved toy predates human flight.", source: "Morris Michtom Archives, Smithsonian", category: "Pop Culture" },
  { dayNumber: 72, factA: "The Black Death pandemic began", yearA: 1347, factB: "Chaucer wrote The Canterbury Tales", yearB: 1387, explanation: "The plague devastated Europe 40 years before Chaucer wrote his masterpiece. Medieval literature emerged from the aftermath of catastrophe.", source: "Medieval History Archives, British Library", category: "History" },
  { dayNumber: 73, factA: "The first successful blood transfusion occurred", yearA: 1818, factB: "Frankenstein was published", yearB: 1818, explanation: "Real blood transfusions and Mary Shelley's monster story emerged the same year. Science and science fiction converged.", source: "Medical Archives, Mary Shelley Papers", category: "Medicine" },
  { dayNumber: 74, factA: "Contact lenses were invented", yearA: 1887, factB: "The Eiffel Tower was completed", yearB: 1889, explanation: "Contact lenses are older than the Eiffel Tower by two years. Victorian vision correction predates Paris's iconic landmark.", source: "German Medical Archives, Tour Eiffel", category: "Technology" },
  { dayNumber: 75, factA: "The Qing Dynasty fell in China", yearA: 1912, factB: "Arizona became a US state", yearB: 1912, explanation: "China's last imperial dynasty and Arizona's statehood happened the same year. Ancient empire and young state changed together.", source: "Chinese Historical Records, US Congress", category: "History" },
  { dayNumber: 76, factA: "John Tyler, 10th US President, was born", yearA: 1790, factB: "His grandchildren were still living", yearB: 2020, explanation: "President Tyler, born in 1790, had grandchildren alive in 2020. Just three generations span 230 years of American history.", source: "Tyler Family Records, Washington Post", category: "History" },
  { dayNumber: 77, factA: "The yo-yo became popular in America", yearA: 1928, factB: "The yo-yo was used in ancient Greece", yearB: -500, explanation: "The yo-yo is an ancient toy that became an American craze millennia after its Greek origins. It's one of the oldest toys still popular today.", source: "Duncan Toys, Greek Archaeological Museum", category: "Pop Culture" },
  { dayNumber: 78, factA: "The chainsaw was invented", yearA: 1830, factB: "Anesthesia was first used in surgery", yearB: 1846, explanation: "Chainsaws existed for 16 years before anesthesia. Early medical procedures were performed without pain relief.", source: "Medical History Museum, Patent Records", category: "Medicine" },
  { dayNumber: 79, factA: "Nintendo released the NES in North America", yearA: 1985, factB: "Microsoft Windows was first released", yearB: 1985, explanation: "The NES and Windows debuted the same year. Video game consoles and personal computing took off together.", source: "Nintendo, Microsoft Corporation", category: "Technology" },
  { dayNumber: 80, factA: "The first Thanksgiving was celebrated", yearA: 1621, factB: "The Dutch bought Manhattan", yearB: 1626, explanation: "Thanksgiving predates New York City by 5 years. Pilgrims feasted before the Dutch made their famous real estate deal.", source: "Plymouth Plantation, Dutch Historical Archives", category: "History" },
  { dayNumber: 81, factA: "The radio was invented", yearA: 1895, factB: "The first movie theater opened", yearB: 1895, explanation: "Radio and movies were born the same year. Two revolutionary entertainment technologies emerged simultaneously.", source: "Marconi Archives, Lumière Brothers", category: "Entertainment" },
  { dayNumber: 82, factA: "The microwave oven was invented", yearA: 1945, factB: "The computer mouse was invented", yearB: 1964, explanation: "Microwave ovens predate the computer mouse by 19 years. Kitchen technology led the way for computing interfaces.", source: "Raytheon Corporation, Stanford Research Institute", category: "Technology" },
  { dayNumber: 83, factA: "The first underground subway opened in London", yearA: 1863, factB: "The light bulb was invented", yearB: 1879, explanation: "The London Underground ran for 16 years before the light bulb. Early subway cars were pulled by steam engines in gas-lit tunnels.", source: "Transport for London, Edison Papers", category: "Transportation" },
  { dayNumber: 84, factA: "The safety pin was invented", yearA: 1849, factB: "The California Gold Rush began", yearB: 1848, explanation: "The Gold Rush started a year before the safety pin was invented. Prospectors couldn't use this fastener that we now take for granted.", source: "US Patent Office, California State Archives", category: "Technology" },
  { dayNumber: 85, factA: "The first Barbie doll was sold", yearA: 1959, factB: "Hawaii became a US state", yearB: 1959, explanation: "Barbie and Hawaiian statehood happened the same year. The iconic doll and the 50th state both arrived in 1959.", source: "Mattel, US Congress", category: "Pop Culture" },
  { dayNumber: 86, factA: "The Mona Lisa was painted", yearA: 1503, factB: "Michelangelo began the Sistine Chapel ceiling", yearB: 1508, explanation: "Da Vinci started the Mona Lisa 5 years before Michelangelo began the Sistine Chapel. Two Renaissance masterpieces, years apart.", source: "Louvre Museum, Vatican Archives", category: "Art" },
  { dayNumber: 87, factA: "The bicycle was invented", yearA: 1817, factB: "The first train ran", yearB: 1804, explanation: "Trains predate bicycles by 13 years. We rode rails before we pedaled two wheels.", source: "German Patent Office, National Railway Museum", category: "Transportation" },
  { dayNumber: 88, factA: "The first programmable computer was built", yearA: 1936, factB: "The Hindenburg disaster occurred", yearB: 1937, explanation: "Zuse's Z1 computer was built a year before the Hindenburg crashed. The digital age began as the airship era ended.", source: "Computer History Museum, German Archives", category: "Technology" },
  { dayNumber: 89, factA: "The sandwich was named", yearA: 1762, factB: "The American Revolution began", yearB: 1775, explanation: "The sandwich got its name 13 years before the Revolution. The Earl of Sandwich's snack predates American independence.", source: "British Culinary Archives, US National Archives", category: "Food" },
  { dayNumber: 90, factA: "The Panama Canal opened", yearA: 1914, factB: "World War I began", yearB: 1914, explanation: "The Panama Canal opened the same year WWI started. A triumph of engineering coincided with unprecedented destruction.", source: "Panama Canal Authority, WWI Archives", category: "History" },
  { dayNumber: 91, factA: "The last execution at the Tower of London occurred", yearA: 1941, factB: "Pearl Harbor was attacked", yearB: 1941, explanation: "A German spy was executed at the Tower of London the same year as Pearl Harbor. Medieval punishment sites were still in use during WWII.", source: "Tower of London Archives, WWII Archives", category: "History" },
  { dayNumber: 92, factA: "The flashlight was invented", yearA: 1899, factB: "The first Tour de France was held", yearB: 1903, explanation: "Flashlights predate the Tour de France by 4 years. Portable electric light came before cycling's greatest race.", source: "Ever-Ready Battery Company, Tour de France", category: "Technology" },
  { dayNumber: 93, factA: "The lie detector was invented", yearA: 1921, factB: "Insulin was first used to treat diabetes", yearB: 1922, explanation: "The polygraph predates insulin treatment by a year. We could detect lies before we could treat a common disease.", source: "UC Berkeley, University of Toronto", category: "Science" },
  { dayNumber: 94, factA: "The shopping cart was invented", yearA: 1937, factB: "The first Walmart opened", yearB: 1962, explanation: "Shopping carts existed 25 years before Walmart. The retail innovation predated the retail giant.", source: "Oklahoma Historical Society, Walmart Archives", category: "Business" },
  { dayNumber: 95, factA: "The stapler was invented", yearA: 1866, factB: "The paper clip was invented", yearB: 1899, explanation: "Staplers predate paper clips by 33 years. We were stapling before we were clipping.", source: "US Patent Office", category: "Technology" },
  { dayNumber: 96, factA: "The first email was sent", yearA: 1971, factB: "The first text message was sent", yearB: 1992, explanation: "Email is 21 years older than texting. We were typing messages on computers long before phones.", source: "ARPANET Records, Vodafone", category: "Technology" },
  { dayNumber: 97, factA: "Pluto was discovered", yearA: 1930, factB: "Pluto was demoted from planet status", yearB: 2006, explanation: "Pluto was a planet for 76 years. It was discovered and demoted within a single human lifetime.", source: "Lowell Observatory, IAU", category: "Science" },
  { dayNumber: 98, factA: "The first casino opened in Las Vegas", yearA: 1931, factB: "Hoover Dam was completed", yearB: 1936, explanation: "Las Vegas casinos predate Hoover Dam by 5 years. Gambling was established before the landmark that powered the city.", source: "Nevada State Archives, Bureau of Reclamation", category: "History" },
  { dayNumber: 99, factA: "Betty White was born", yearA: 1922, factB: "Sliced bread was invented", yearB: 1928, explanation: "Betty White was older than sliced bread. The beloved actress was born 6 years before the famous invention.", source: "SAG-AFTRA, Chillicothe Baking Company", category: "Pop Culture" },
  { dayNumber: 100, factA: "The moon landing occurred", yearA: 1969, factB: "The last man walked on the moon", yearB: 1972, explanation: "Only 3 years separated the first and last moonwalks. Humanity's entire era of lunar exploration lasted shorter than a presidential term.", source: "NASA", category: "Space" },
];
...
async function main() {
  ...
  await prisma.beforeAfterQuestion.deleteMany();
  ...
  // Seed Before & After questions
  for (const question of beforeAfterQuestions) {
    await prisma.beforeAfterQuestion.create({
      data: question,
    });
  }
  console.log(`Seeded ${beforeAfterQuestions.length} Before & After questions`);
